...
const webAppUrl = "https://script.google.com/macros/s/AKfycbz0Ux0vEp9J-FpphoVF64lriW-N2GfIn-HGEABrvEcTU-zcV8nk9F65QoR6ScsN-PCq/exec";
...
document.getElementById("formMovimentos").addEventListener("submit", async (e) => {
    ...
    itensSecoes.forEach(secao => {
        ...
        registros.push({
            ...
            local: secao.querySelector(".local").value  // Local por último, sem observacao
        });
    });
