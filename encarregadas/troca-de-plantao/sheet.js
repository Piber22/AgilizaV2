...
const URL_APPS_SCRIPT = 'https://script.google.com/macros/s/AKfycbwwfy_TT83w67Nmy1a8Z5uA4YLuJlzE0IVHuX1jLbNnCodix8OpsdrZPF6sEw7gXs5syQ/exec';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (btnCopiar) {
        btnCopiar.addEventListener("click", async function() {
            ...
            setTimeout(async () => {
                if (typeof dadosRecebidos !== 'undefined' && dadosRecebidos.data) {
